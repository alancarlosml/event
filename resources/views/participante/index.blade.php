                        ...
                        <tbody>
                            @foreach($participantes as $participante)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="btn btn-primary btn-sm mr-1" href="{{route('participante.show', $participante->id)}}">
                                                <i class="fas fa-eye">
                                                </i>
                                                Detalhes
                                            </a>
                                            ...
                                            <a class="btn btn-info btn-sm mr-1" href="{{route('participante.edit', $participante->id)}}">
                                            ...
                                            <form action="{{ route('participante.destroy', $participante->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-danger btn-sm mr-1"  href="javascript:;" onclick="removeData({{$participante->id}})">
                                                    <i class="fas fa-trash">
                                                    </i>
                                                    Remover
                                                </a>
                                                {{-- <a class="btn btn-danger m-1 btn-remove" href="javascript:;" onclick="removeData({{$participante->id}})">Remover</a> --}}
                                                <button class="d-none" id="btn-remove-hidden-{{$participante->id}}">Remover</button>
                                            </form>
                                        </div>
                                    </td>
                                    <div class="modal fade modalMsgRemove" id="modalMsgRemove-{{$participante->id}}" tabindex="-1" role="dialog" aria-labelledby="modalMsgRemoveLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalMsgRemoveLabel">Remoção de participante</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" id="btn-remove-ok-{{$participante->id}}" onclick="removeSucc({{$participante->id}})">Sim</button>
