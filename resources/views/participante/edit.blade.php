        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <div class="card-body table-responsive p-0">
                    <form method="POST" action="{{route('participante.update', $participante->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="form-check pb-3">
                          <div class="custom-switch">
                              <input type="checkbox" @if($participante->status == 1) checked="checked" @endif class="custom-control-input" name="status" id="status" value="1">
