...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_conference/css/modern-event.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/css/frontend-unified.css') }}" type="text/css">
    @stack('theme')
</head>
