...
<head>
    ...
    <style>
        ...
        .ftco-section .social-media .social-icon:hover,
        .ftco-section .social-media .social-icon:focus {
            background: #e3b04b;
        }

        .ftco-section .social-media .social-icon:hover span,
        .ftco-section .social-media .social-icon:focus span {
            color: #fff;
        }
