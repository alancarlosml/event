                ...
                <div class="card-body table-responsive p-0">
                    <div class="card-body">
                        <div class="form-group text-right">
                            <a href="{{route('event.create_coupon', $event->id)}}" class="btn btn-success">Cadastrar novo cupom</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form action="{{ route('event.destroy_coupon', $coupon->id) }}" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <a class="btn btn-danger btn-sm mr-1"  href="javascript:;" onclick="removeData({{$coupon->id}})">
                                                        <i class="fas fa-trash">
                                                        </i>
                                                        Remover
                                                    </a>
                                                    <button class="d-none" id="btn-remove-hidden-{{$coupon->id}}">Remover</button>
                                                </form>
                                            </div>
                                        </td>
                                        <div class="modal fade modalMsgRemove" id="modalMsgRemove-{{$coupon->id}}" tabindex="-1" role="dialog" aria-labelledby="modalMsgRemoveLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" id="btn-remove-ok-{{$coupon->id}}" onclick="removeSucc({{$coupon->id}})">Sim</button>
