                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select id="type" class="form-control col-md-3" id="type"
                                                ...
                                                <option value="0"
                                                        @if ($lote->type == 0) selected @endif>Pago</option>
                                                <option value="1"
                                                        @if ($lote->type == 1) selected @endif>Grátis
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-row card-body mb-2"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select id="tax_parcelamento" class="form-control" id="tax_parcelamento"
                                                    ...
                                                    <option selected>Selecione</option>
                                                    <option value="0"
                                                            @if ($lote->tax_parcelamento == 0) selected @endif>Pago pelo
                                                        participante</option>
                                                    <option value="1"
                                                            @if ($lote->tax_parcelamento == 1) selected @endif>Pago pelo
                                                        organizador</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-3">
                                                ...
                                                <select id="tax_service" class="form-control" id="tax_service"
                                                    ...
                                                    <option selected>Selecione</option>
                                                    <option value="0"
                                                            @if ($lote->tax_service == 0) selected @endif>Pago pelo
                                                        participante</option>
                                                    <option value="1"
                                                            @if ($lote->tax_service == 1) selected @endif>Pago pelo
                                                        organizador</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="value" name="value"
                                                       placeholder="50,00" value="{{ $lote->value }}">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="value">Forma de pagamento</label> <br />
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="form_pagamento[]" value="1" @if(in_array('1', explode(',', $lote->form_pagamento))) checked @endif>
                                                    <label class="form-check-label" for="inlineCheckbox1">Cartão de crédito</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="form_pagamento[]" value="2" @if(in_array('2', explode(',', $lote->form_pagamento))) checked @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="form_pagamento[]" value="3" @if(in_array('3', explode(',', $lote->form_pagamento))) checked @endif>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                       placeholder="Nome" value="{{ $lote->name }}">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="quantity">Quantidade*</label>
                                                <input type="number" class="form-control" id="quantity"
                                                       name="quantity" placeholder="0" value="{{ $lote->quantity }}"
                                                       min="0">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="number" class="form-control" id="limit_min"
                                                       ...
                                                       value="{{ old('limit_min', $lote->limit_min) }}"
                                                       min="0">
                                            </div>
                                            <div class="form-group col-md-3">
                                                Máximo
                                                <input type="number" class="form-control" id="limit_max"
                                                       ...
                                                       value="{{ old('limit_max', $lote->limit_max) }}"
                                                       min="0">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="hidden" name="reservationtime_begin_hidden"
                                                       id="reservationtime_begin_hidden"
                                                       value="{{ $lote->datetime_begin }}">
                                            </div>
                                            <div class="form-group col-md-3">
                                                Fim
                                                ...
                                                <input type="hidden" name="reservationtime_end_hidden"
                                                       id="reservationtime_end_hidden"
                                                       value="{{ $lote->datetime_end }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="visibility" class="form-control col-md-3" name="visibility">
                                                <option selected>Selecione</option>
                                                <option value="0"
                                                        @if ($lote->visibility == 0) selected @endif>Público
                                                </option>
                                                <option value="1"
                                                        @if ($lote->visibility == 1) selected @endif>Privado
                                                </option>
                                            </select>
                                        </div>
                                    </div>
