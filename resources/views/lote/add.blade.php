                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row card-body mb-2" style="border: solid 1px #ddd; border-radius: 0.25rem;" id="value_div">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="value" name="value" placeholder="50,00">
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                  Mínimo
                                  <input type="number" class="form-control" id="limit_min" name="limit_min" placeholder="0" value="{{old('limit_min')}}" min="0">
                                </div>
                                <div class="form-group col-md-3">
                                  Máximo
                                  <input type="number" class="form-control" id="limit_max" name="limit_max" placeholder="0" value="{{old('limit_max')}}" min="0">
                                </div>
                            </div>
                            <div class="form-row">
