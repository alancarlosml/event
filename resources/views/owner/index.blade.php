                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <form action="{{ route('owner.destroy', $owner->id) }}"
                                                            ...
                                                            <button class="d-none"
                                                                    id="btn-remove-hidden-{{ $owner->id }}">Remover</button>
                                                        </form>
                                                    </div>
                                                </td>
                                                <div class="modal fade modalMsgRemove"
                                                     id="modalMsgRemove-{{ $owner->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger"
                                                                        id="btn-remove-ok-{{ $owner->id }}"
                                                                        onclick="removeSucc({{ $owner->id }})">Sim</button>
