                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <div class="space-y-4">
                              <h3 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 28px; margin: 0;" align="left">Olá, {{Str::of($admin->name)->explode(' ')[0]}}!</h3>
                                  ...
                                  <tr>
                                    <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
                                      &#160;
							             ...
							             <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Você foi convidado pelo {{Str::of($admin->name)->explode(' ')[0]}} a gerenciar o seguinte evento.</p>
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
