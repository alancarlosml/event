                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <div class="space-y-4">
                              <h3 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 28px; margin: 0;" align="left">Olá, {{Str::of($event->get_participante_admin()->name)->explode(' ')[0]}}!</h3>
							  ...
							  <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Seu evento foi {{$acao}} com sucesso!</p>
							  <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
							  ...
							  @id($acao == 'salvo')
							  <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left"><b>Atenção! Seu evento foi criado mas ainda não está publicado. Caso deseje publicar seu evento, acesse <a href="https://www.lojadeeventos.com.br/painel/meus-eventos">seus eventos</a> e faça a publicação.</b></p>
							  @endif
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#F1f1f5">
                                    <h3 class="text-center" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center">{{$event->name}}</h3>
                                    <table class="p-2 w-full" border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin-top: 20px" width="100%">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="left" width="100%"><b>Categoria: </b> {{ $event->area->category->description}}</td>
                                        </tr>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 8px;" align="left" width="100%"><b>Total de vagas:</b> {{ $event->max_tickets}}</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table class="hr" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; height: 1px; width: 100%; margin: 0;" align="left">
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
