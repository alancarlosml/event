                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-lg-6 col-sm-12" id="name"
                                                name="name" placeholder="Nome" value="{{ $event->name }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control col-lg-4 col-sm-12"
                                                    ...
                                                    aria-describedby="basic-addon3" value="{{ $event->slug }}">
                                            </div>
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" placeholder="URL do evento" value="{{$event->slug}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-lg-6 col-sm-12" id="subtitle"
                                                name="subtitle" placeholder="Subtítulo" value="{{ $event->subtitle }}">
                                        </div>
                                        <div class="form-group">
                                ...
                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-lg-6 col-sm-12"
                                                id="participante_email" name="participante_email"
                                                placeholder="Participante" value="{{ $event->participante_email }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            @else
                                                <div class="form-group">
                                                    <img src="{{ asset('storage/' . $event->banner) }}"
                                                        alt="Banner evento" class="img-fluid img-thumbnail"
                                                        style="width: 400px">
                                                    <a href="{{ route('event.delete_file', $event->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control col-lg-2 col-sm-12"
                                                ...
                                                value="{{ old('max_tickets', $event->max_tickets) }}" min="0">
                                        </div>
                                    </div>
                                    <hr>
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <select id="state" class="form-control" name="state"
                                                        ...
                                                        @foreach ($states as $state)
                                                            <option value="{{ $state->id }}"
                                                                @if ($event->city_uf == $state->id) selected @endif>
                                                                {{ $state->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input type="hidden" name="city_id_hidden" id="city_id_hidden"
                                                        value="{{ $event->city_id }}">
                                                    <input type="hidden" name="area_id_hidden" id="area_id_hidden"
                                                        value="{{ $event->area_id }}">
                                                </div>
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" id="zip"
                                                        ...
                                                        value="{{ $event->place_zip }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
