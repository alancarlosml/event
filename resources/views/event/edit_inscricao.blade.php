                    ...
                    <form method="POST" action="{{route('event.participantes.update', $participanteLote->order_item_id)}}">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" disabled class="form-control" id="number" placeholder="Número" value="{{$participanteLote->number}}">
                            </div>
                            <div class="form-group">
                                <label for="participante">Participante</label>
                                <input type="text" disabled class="form-control" id="participante" placeholder="Participante" value="{{$participanteLote->participante_name}}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="lote_id" name="lote_id">
                                    ...
                                    <option value="{{$lote->id}}" @if($participanteLote->lote_id == $lote->id) selected @endif>{{$lote->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status">
                                    <option>Selecione</option>
                                    <option value="1" @if($participanteLote->status == 1) selected @endif>Confirmado</option>
                                    <option value="2" @if($participanteLote->status == 2) selected @endif>Pendente</option>
                                    <option value="3" @if($participanteLote->status == 3) selected @endif>Cancelado</option>
                                </select>
                            </div>
                        </div>
                        <!-- /.card-body -->
