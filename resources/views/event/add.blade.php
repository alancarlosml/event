                                ...
                                <form method="POST" action="{{ route('event.store') }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-lg-6 col-sm-12" id="name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control col-lg-4 col-sm-12"
                                                    id="slug" name="slug" placeholder="URL do evento"
                                                    aria-describedby="basic-addon3" required>
                                            </div>
                                            <small id="slugHelp" class="form-text text-danger d-none">Essa URL já está
                                                em uso, por favor, selecione outra.</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="subtitle">Subtítulo</label>
                                            <input type="text" class="form-control col-lg-6 col-sm-12" id="subtitle"
                                                name="subtitle" placeholder="Subtítulo" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-lg-6 col-sm-12"
                                                id="owner_email" name="owner_email" placeholder="Organizador" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control col-lg-2 col-sm-12" id="total"
                                                name="total" placeholder="0" required min="0">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group date" id="datetimepicker_hour_begin"
                                                    data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        data-target="#datetimepicker_hour_begin" />
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group date" id="datetimepicker_hour_end"
                                                    data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        data-target="#datetimepicker_hour_end" />
                                                    <div class="input-group-append"
                                                        data-target="#datetimepicker_hour_end"
                                                        data-toggle="datetimepicker">
                                                        <div class="input-group-text"><i
                                            ...
                                            <div class="form-group col-md-2">
                                                <a class="btn btn-success btn-sm mr-1" style="margin-top: 35px"
                                                    href="#">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                <a class="btn btn-danger btn-sm mr-1" style="margin-top: 35px"
                                                    href="#">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="place_name"
                                                name="place_name" placeholder="Local" required>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-10">
                                                <label for="address">Rua*</label>
                                                <input type="text" class="form-control" id="address"
                                                    name="address" placeholder="Rua" required>
                                            </div>
                                            <div class="form-group col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="district"
                                                name="district" placeholder="Bairro" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control" id="zip"
                                                    name="zip" placeholder="CEP" required>
                                            </div>
                                        </div>
                                    </div>
                                    <hr />
