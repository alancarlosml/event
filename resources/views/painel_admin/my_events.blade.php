                        ...
                        <tbody>
                            @foreach($events as $event)
                                <tr>
                                    ...
                                    <td>@if($event->status == 1) <span class="badge badge-success">Publicado</span> @else <span class="badge badge-danger">Não publicado</span> @endif</td>
                                    <td>
                                        <div class="d-flex">
