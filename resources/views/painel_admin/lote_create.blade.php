                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="number" class="form-control" id="quantity" name="quantity" placeholder="0" min="0" value="{{ $lote->quantity ?? '' }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                      Mínimo
                                      <input type="number" class="form-control" id="limit_min" name="limit_min" placeholder="0" value="{{ $lote->limit_min ?? '' }}" min="0">
                                    </div>
                                    <div class="form-group col-md-3">
                                      Máximo
                                      <input type="number" class="form-control" id="limit_max" name="limit_max" placeholder="0" value="{{ $lote->limit_max ?? '' }}" min="0">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group date" id="datetimepicker_day_begin" data-target-input="nearest">
                                            <input class="form-control datetimepicker-input datetimepicker_day" id="input_datetimepicker_day_begin" data-target="#datetimepicker_day_begin" name="datetime_begin" autocomplete="off"/>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group date" id="datetimepicker_day_end" data-target-input="nearest">
                                            <input class="form-control datetimepicker-input datetimepicker_day" id="input_datetimepicker_day_end" data-target="#datetimepicker_day_end" name="datetime_end" autocomplete="off"/>
