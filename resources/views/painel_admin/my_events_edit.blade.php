                    ...
                    <form method="POST" action="{{ route('event_home.create.step.one') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description"> {{ $event->description ?? old('description') }}</textarea>
                            </div>
                            <div class="form-row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="paid" id="inlineRadio_mercadopago" value="0" {{ $event->paid == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="paid" id="inlineRadio_nenhuma" value="1" {{ $event->paid == 0 ? 'checked' : '' }}>
