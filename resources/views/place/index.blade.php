                            ...
                            @foreach($places as $place)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <b>Complemento:</b> @if($place->complement != ''){{$place->complement}} @else - @endif<br/>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="btn btn-primary btn-sm mr-1" href="{{route('place.show', $place->id)}}">
                                                <i class="fas fa-eye">
                                                </i>
                                                Detalhes
                                            </a>
                                            ...
                                            <a class="btn btn-info btn-sm mr-1" href="{{route('place.edit', $place->id)}}">
                                            ...
                                            <form action="{{ route('place.destroy', $place->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-danger btn-sm mr-1"  href="javascript:;" onclick="removeData({{$place->id}})">
                                                    <i class="fas fa-trash">
                                                    </i>
                                                    Remover
                                                </a>
                                                {{-- <a class="btn btn-danger m-1 btn-remove" href="javascript:;" onclick="removeData({{$place->id}})">Remover</a> --}}
                                                <button class="d-none" id="btn-remove-hidden-{{$place->id}}">Remover</button>
                                            </form>
                                        </div>
                                    </td>
                                    <div class="modal fade modalMsgRemove" id="modalMsgRemove-{{$place->id}}" tabindex="-1" role="dialog" aria-labelledby="modalMsgRemoveLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalMsgRemoveLabel">Remoção de local</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" id="btn-remove-ok-{{$place->id}}" onclick="removeSucc({{$place->id}})">Sim</button>
