                    ...
                    <form method="POST" action="{{route('place.update', $place->id)}}">
                        ...
                        <div class="card-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Local" value="{{$place->name}}">
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-10">
                              <label for="address">Rua</label>
                              <input type="text" class="form-control" id="address" name="address" placeholder="Rua" value="{{$place->address}}">
                            </div>
                            <div class="form-group col-md-2">
                              <label for="number">Número</label>
                              <input type="text" class="form-control" id="number" name="number" placeholder="Número" value="{{$place->number}}">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="district">Bairro</label>
                            <input type="text" class="form-control" id="district" name="district" placeholder="Bairro" value="{{$place->district}}">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-5">
                                ...
                                <select id="state" class="form-control" name="state">
                                  ...
                                  @foreach ($states as $state)
                                    <option value="{{$state->id}}" @if($place->city_uf == $state->uf) selected @endif>{{$state->name}}</option>
                                  @endforeach
                                </select>
                              </div>
                            <div class="form-group col-md-5">
                            ...
                            <div class="form-group col-md-2">
                              ...
                              <input type="text" class="form-control" id="zip" name="zip" placeholder="CEP" value="{{$place->zip}}">
                            </div>
                          </div>                          
                        </div>
                        <!-- /.card-body -->
